...
[![Docs.rs](https://docs.rs/navian-dst/badge.svg)](https://docs.rs/navian-dst)
[![License: Apache-2.0](https://img.shields.io/badge/license-Apache--2.0-blue.svg)](../../LICENSE)

`navian-dst` is a domain-agnostic DST substrate. It replaces the sources of
...
```rust
use navian_dst::{ddmin, Delivery, FaultSchedule, SimulatedNetwork};
...
[navian-dst project](https://github.com/TheFuturePlutus/navian-dst) ships an **AI-native install
layer** (`/dst-init` for Claude Code, a rule for Cursor) plus the **`navian-dst` CLI**
(`navian-dst scan` + `navian-dst migrate`) that does it for you — scan the leaks, rewrite the
